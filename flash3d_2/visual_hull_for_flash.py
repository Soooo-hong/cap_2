...
def act_visual_hull(pred) : 
    ...
    parser.add_argument('--sparse_id', type=int, default=2, help='sparse id')
    ...
    pcd, bbox = get_visual_hull(args.voxel_num, init_bbox, scene_info, cam_center,cam_info)
